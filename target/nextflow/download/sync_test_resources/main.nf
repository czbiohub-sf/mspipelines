...
thisFunctionality = [
  ...
  'arguments': [
    [
      ...
      'default': 's3://czbiohub-pipelines/resources_test_ms',
      'multiple': false
    ],
    [
      'name': 'output',
...
thisHelpMessage = '''sync_test_resources 0.3.0

Synchronise the test resources from s3://czbiohub-pipelines/resources_test_ms to
resources_test

Usage:
sync_test_resources
sync_test_resources --input s3://czbiohub-pipelines/resources_test_ms --output
resources_test
