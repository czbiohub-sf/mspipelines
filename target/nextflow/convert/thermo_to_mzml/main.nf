    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/mspipelines/mspipelines/src/convert/thermo_to_mzml/config.vsh.yaml"
      }
    ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/mspipelines/convert_thermo_to_mzml",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
