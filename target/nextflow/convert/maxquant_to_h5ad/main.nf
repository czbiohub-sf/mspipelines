...
// 0000-0003-3641-729X}
//  * Kenneth Verheggen <kenneth@data-intuitive.com> (maintainer) {github:
// KennethVerheggen}
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/mspipelines/mspipelines/src/convert/maxquant_to_h5ad/config.vsh.yaml"
      }
    ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/mspipelines/convert_maxquant_to_h5ad",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
