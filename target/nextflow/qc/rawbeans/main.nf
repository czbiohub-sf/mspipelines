...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/mspipelines/mspipelines/src/qc/rawbeans/config.vsh.yaml"
      }
    ],
  ...
  "platforms" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          ...
          "user" : false,
          "git" : [
            "https://bitbucket.org/incpm/prot-qc.git"
          ],
          "upgrade" : true
        }
      ]
  ...
  "info" : {
    "config" : "/home/runner/work/mspipelines/mspipelines/src/qc/rawbeans/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
...
$( if [ ! -z ${VIASH_PAR_NO_REPORT+x} ]; then echo "${VIASH_PAR_NO_REPORT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_no_report='&'#" ; else echo "# par_no_report="; fi )
$( if [ ! -z ${VIASH_PAR_MASS+x} ]; then echo "${VIASH_PAR_MASS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_mass='&'#" ; else echo "# par_mass="; fi )
