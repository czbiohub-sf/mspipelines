...
$( if [ ! -z ${VIASH_PAR_BATCH+x} ]; then echo "${VIASH_PAR_BATCH}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_batch='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_NO_REPORT+x} ]; then echo "${VIASH_PAR_NO_REPORT}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_no_report='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_MASS+x} ]; then echo "${VIASH_PAR_MASS}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_mass='&'#" ; fi )
