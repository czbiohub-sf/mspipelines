...
thisConfig = processConfig(jsonSlurper.parseText('''{
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
    "git_commit" : "1c97554084885afe8e9a6f8279e74298745e2967",
...
par = {
  ...
  'data_type': $( if [ ! -z ${VIASH_PAR_DATA_TYPE+x} ]; then echo "r'${VIASH_PAR_DATA_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'ion_mode': $( if [ ! -z ${VIASH_PAR_ION_MODE+x} ]; then echo "r'${VIASH_PAR_ION_MODE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'accuracy_type': $( if [ ! -z ${VIASH_PAR_ACCURACY_TYPE+x} ]; then echo "r'${VIASH_PAR_ACCURACY_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'mass_range_begin': $( if [ ! -z ${VIASH_PAR_MASS_RANGE_BEGIN+x} ]; then echo "float(r'${VIASH_PAR_MASS_RANGE_BEGIN//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'mass_range_end': $( if [ ! -z ${VIASH_PAR_MASS_RANGE_END+x} ]; then echo "float(r'${VIASH_PAR_MASS_RANGE_END//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'average_peak_width': $( if [ ! -z ${VIASH_PAR_AVERAGE_PEAK_WIDTH+x} ]; then echo "int(r'${VIASH_PAR_AVERAGE_PEAK_WIDTH//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'mass_accuracy': $( if [ ! -z ${VIASH_PAR_MASS_ACCURACY+x} ]; then echo "float(r'${VIASH_PAR_MASS_ACCURACY//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'ri_index_file': $( if [ ! -z ${VIASH_PAR_RI_INDEX_FILE+x} ]; then echo "r'${VIASH_PAR_RI_INDEX_FILE//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'retention_type': $( if [ ! -z ${VIASH_PAR_RETENTION_TYPE+x} ]; then echo "r'${VIASH_PAR_RETENTION_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'ri_compound': $( if [ ! -z ${VIASH_PAR_RI_COMPOUND+x} ]; then echo "r'${VIASH_PAR_RI_COMPOUND//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'retention_index_tolerance_for_identification': $( if [ ! -z ${VIASH_PAR_RETENTION_INDEX_TOLERANCE_FOR_IDENTIFICATION+x} ]; then echo "float(r'${VIASH_PAR_RETENTION_INDEX_TOLERANCE_FOR_IDENTIFICATION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'ei_similarity_tolerance_for_identification': $( if [ ! -z ${VIASH_PAR_EI_SIMILARITY_TOLERANCE_FOR_IDENTIFICATION+x} ]; then echo "float(r'${VIASH_PAR_EI_SIMILARITY_TOLERANCE_FOR_IDENTIFICATION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'only_report_top_hit': $( if [ ! -z ${VIASH_PAR_ONLY_REPORT_TOP_HIT+x} ]; then echo "r'${VIASH_PAR_ONLY_REPORT_TOP_HIT//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'alignment_index_type': $( if [ ! -z ${VIASH_PAR_ALIGNMENT_INDEX_TYPE+x} ]; then echo "r'${VIASH_PAR_ALIGNMENT_INDEX_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'retention_index_tolerance_for_alignment': $( if [ ! -z ${VIASH_PAR_RETENTION_INDEX_TOLERANCE_FOR_ALIGNMENT+x} ]; then echo "float(r'${VIASH_PAR_RETENTION_INDEX_TOLERANCE_FOR_ALIGNMENT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'ei_similarity_tolerance_for_alignment': $( if [ ! -z ${VIASH_PAR_EI_SIMILARITY_TOLERANCE_FOR_ALIGNMENT+x} ]; then echo "float(r'${VIASH_PAR_EI_SIMILARITY_TOLERANCE_FOR_ALIGNMENT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'ei_similarity_factor_for_alignment': $( if [ ! -z ${VIASH_PAR_EI_SIMILARITY_FACTOR_FOR_ALIGNMENT+x} ]; then echo "float(r'${VIASH_PAR_EI_SIMILARITY_FACTOR_FOR_ALIGNMENT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
