  ...
  "platforms" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "mkdir /maxquant && cd /maxquant && wget -q https://www.dropbox.com/s/6aijsx0v3zvkfqu/MaxQuant_2.0.3.1.zip -O MaxQuant_2.0.3.1.zip && unzip MaxQuant_2.0.3.1.zip && rm MaxQuant_2.0.3.1.zip && cd $(find /maxquant/* -type d -maxdepth 1) && mv * /maxquant"
          ]
        },
        {
          "type" : "python",
...
par = {
  ...
  'input_experiment': $( if [ ! -z ${VIASH_PAR_INPUT_EXPERIMENT+x} ]; then echo "r'${VIASH_PAR_INPUT_EXPERIMENT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'input_fraction': $( if [ ! -z ${VIASH_PAR_INPUT_FRACTION+x} ]; then echo "list(map(int, r'${VIASH_PAR_INPUT_FRACTION//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi ),
  'input_ptm': $( if [ ! -z ${VIASH_PAR_INPUT_PTM+x} ]; then echo "list(map(lambda x: (x.lower() == 'true'), r'${VIASH_PAR_INPUT_PTM//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi ),
